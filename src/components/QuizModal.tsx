    ...
    <>
      ...
      {open ? (
        ...
        >
          ...
          <div className="relative w-full max-w-xl max-h-[85vh] overflow-y-auto panel bg-bg-raised/95 p-5 shadow-glow">
            <div className="flex items-start justify-between gap-3">
              <div>
                <div className="field-label">Quiz</div>
                <h2 className="mt-1 text-lg font-semibold text-ink">{itemTitle}</h2>
              </div>
              <button
                onClick={close}
